...
<head>
    ...
    <title>Crear Usuario - CORPORACIÓN ADIVON SAC</title>
                ...
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Asignar a un almacén o tienda específica</p>
                            @error('almacen_id')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="direccion" rows="2"
                                      class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('direccion') }}</textarea>
                        </div>
                    </div>
