        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div class="px-6 py-4" style="background: linear-gradient(135deg, #2B2E2C 0%, #3A3E3B 100%);">
                    <h1 class="text-xl font-bold text-white">Nuevo Motivo de Movimiento</h1>
                    <p class="text-white/70 text-sm">Registrar un nuevo motivo para movimientos de inventario</p>
                </div>

                <form action="{{ route('catalogo.motivos.store') }}" method="POST" class="p-6 space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        @php $tipoOld = old('tipo', 'ingreso'); @endphp
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre" id="nombre"
                               ...
                               placeholder="Ej: Compra de mercadería, Venta al cliente, Devolución..."
