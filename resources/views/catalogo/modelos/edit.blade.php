        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div class="px-6 py-4" style="background: linear-gradient(135deg, #2B2E2C 0%, #3A3E3B 100%);">
                    ...
                    <p class="text-white/70 text-sm">Modificar información del modelo</p>
                </div>
                ...
                <form action="{{ route('catalogo.modelos.update', $modelo) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="especificaciones_tecnicas" id="especificaciones_tecnicas" rows="3"
                                  ...
                                  class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#F7D600] focus:border-transparent transition">{{ old('especificaciones_tecnicas', $modelo->especificaciones_tecnicas) }}</textarea>
                    </div>
                        ...
                        <div class="flex items-center gap-4">
                            <div id="imagePreviewContainer" class="hidden">
                                <img id="imagePreview" src="" alt="Vista previa"
                                     class="h-24 w-24 object-cover rounded-lg border-2 border-[#2B2E2C]/30">
                            </div>
                            <div class="flex-1">
