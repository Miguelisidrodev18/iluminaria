...
<div x-data="{ sidebarOpen: false }">
    <button @click="sidebarOpen = true"
            class="md:hidden fixed top-4 left-4 z-40 bg-[#2B2E2C] text-white p-2 rounded-lg shadow-lg">
    ...
    <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'"
            class="fixed left-0 top-0 h-full w-64 bg-[#2B2E2C] text-white shadow-xl z-50 transition-transform duration-300 ease-in-out"
            x-data="{
        ...
        <div class="p-4 border-b border-[#3A3E3B] flex items-center justify-between gap-2">
            ...
            <button @click="sidebarOpen = false" class="md:hidden text-[#F7D600] hover:text-white shrink-0">
                <i class="fas fa-times text-xl"></i>
            </button>
        </div>

        <div class="p-4 bg-[#333836]">
            <div class="flex items-center space-x-3">
                <div class="rounded-full p-2" style="background-color:#F7D600;">
                    <i class="fas fa-user" style="color:#2B2E2C;"></i>
                </div>
                <div class="flex-1">
                    <p class="text-sm font-semibold">{{ auth()->user()->name }}</p>
                    <p class="text-xs text-[#F7D600]">{{ $role }}</p>
                </div>
            </div>
        </div>
                ...
                @if($role == 'Administrador')
                    ...
                    <li>
                        <a href="{{ route('admin.dashboard') }}"
                            class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-[#3A3E3B]' : '' }}">
                    ...
                    <li>
                        <button @click="reportesOpen = !reportesOpen"
                                class="w-full flex items-center justify-between px-4 py-3 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('reportes.*') ? 'bg-[#3A3E3B]' : '' }}">
                        ...
                        <ul x-show="reportesOpen" x-transition class="ml-4 mt-2 space-y-1">
                            <li>
                                <a href="{{ route('reportes.ventas') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('reportes.ventas') ? 'bg-[#484E4A]' : '' }}">
                        ...
                        <ul x-show="ventasOpen" x-transition class="ml-4 mt-2 space-y-1">
                            ...
                            <li>
                                <a href="{{ route('ventas.index') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('ventas.index') || request()->routeIs('ventas.show') || request()->routeIs('ventas.create') ? 'bg-[#484E4A]' : '' }}">
                    ...
                    <li>
                        <button @click="comprasOpen = !comprasOpen"
                                class="w-full flex items-center justify-between px-4 py-3 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('compras.*') || request()->routeIs('pedidos.*') || request()->routeIs('proveedores.*') || request()->routeIs('cuentas-por-pagar.*') ? 'bg-[#3A3E3B]' : '' }}">
                            <span class="flex items-center">
                        ...
                        <ul x-show="inventarioOpen" x-transition class="ml-4 mt-2 space-y-1">
                            ...
                            <li>
                                <a href="{{ route('inventario.reportes.stock-valorizado') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('inventario.reportes.stock-valorizado') ? 'bg-[#484E4A]' : '' }}">
                                    <i class="fas fa-coins mr-3 text-sm"></i>Stock Valorizado
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('inventario.reportes.kardex') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('inventario.reportes.kardex') ? 'bg-[#484E4A]' : '' }}">
                                    <i class="fas fa-book-open mr-3 text-sm"></i>Kardex
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('inventario.reportes.abc') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('inventario.reportes.abc') ? 'bg-[#484E4A]' : '' }}">
                    ...
                    <li>
                        <button @click="trasladosOpen = !trasladosOpen"
                                class="w-full flex items-center justify-between px-4 py-3 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('traslados.*') ? 'bg-[#3A3E3B]' : '' }}">
                            <span class="flex items-center">
                        ...
                        <ul x-show="trasladosOpen" x-transition class="ml-4 mt-2 space-y-1">
                            <li>
                                <a href="{{ route('traslados.index') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('traslados.index') || request()->routeIs('traslados.show') ? 'bg-[#484E4A]' : '' }}">
                                    <i class="fas fa-exchange-alt mr-3 text-sm"></i>Historial
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('traslados.stock') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('traslados.stock') ? 'bg-[#484E4A]' : '' }}">
                                    <i class="fas fa-boxes mr-3 text-sm"></i>Ver Stock
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('traslados.pendientes') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('traslados.pendientes') ? 'bg-[#484E4A]' : '' }}">
                                    <i class="fas fa-clock mr-3 text-sm"></i>Pendientes
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('traslados.create') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('traslados.create') ? 'bg-[#484E4A]' : '' }}">
                        ...
                        <ul x-show="cajaOpen" x-transition class="ml-4 mt-2 space-y-1">
                            <li>
                                <a href="{{ route('caja.index') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('caja.index') ? 'bg-[#484E4A]' : '' }}">
                                    <i class="fas fa-history mr-3 text-sm"></i>Historial de Cajas
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('caja.actual') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('caja.actual') ? 'bg-[#484E4A]' : '' }}">
                    ...
                    <li>
                        <button @click="catalogoOpen = !catalogoOpen"
                                class="w-full flex items-center justify-between px-4 py-3 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('catalogo.*') ? 'bg-[#3A3E3B]' : '' }}">
                            <span class="flex items-center">
                        ...
                        <ul x-show="catalogoOpen" x-transition class="ml-4 mt-2 space-y-1">
                            <li>
                                <a href="{{ route('catalogo.colores.index') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('catalogo.colores.*') ? 'bg-[#484E4A]' : '' }}">
                            ...
                            <li>
                                <a href="{{ route('catalogo.unidades.index') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('catalogo.unidades.*') ? 'bg-[#484E4A]' : '' }}">
                                    <i class="fas fa-ruler mr-3 text-sm"></i>Unidades de Medida
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('catalogo.motivos.index') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('catalogo.motivos.*') ? 'bg-[#484E4A]' : '' }}">
                    ...
                    <li>
                        <button @click="adminOpen = !adminOpen"
                                class="w-full flex items-center justify-between px-4 py-3 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('admin.empresa.*') || request()->routeIs('admin.sucursales.*') || request()->routeIs('admin.cajas.*') ? 'bg-[#3A3E3B]' : '' }}">
                            <span class="flex items-center">
                        ...
                        <ul x-show="adminOpen" x-transition class="ml-4 mt-2 space-y-1">
                            <li>
                                <a href="{{ route('admin.empresa.edit') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('admin.empresa.*') ? 'bg-[#484E4A]' : '' }}">
                                    <i class="fas fa-building mr-3 text-sm"></i>Empresa
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.sucursales.index') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('admin.sucursales.*') ? 'bg-[#484E4A]' : '' }}">
                                    <i class="fas fa-store mr-3 text-sm"></i>Sucursales
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.cajas.dashboard') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('admin.cajas.*') ? 'bg-[#484E4A]' : '' }}">
                ...
                @elseif($role == 'Almacenero')
                    ...
                    <li>
                        <a href="{{ route('almacenero.dashboard') }}"
                            class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('almacenero.dashboard') ? 'bg-[#3A3E3B]' : '' }}">
                            <i class="fas fa-tachometer-alt mr-3"></i>Dashboard
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul x-show="catalogoOpen" x-transition class="ml-4 mt-2 space-y-1">
                            <li>
                                <a href="{{ route('catalogo.colores.index') }}"
                                    class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors">
                                    <i class="fas fa-palette mr-3 text-sm"></i>Colores
                                </a>
                            </li>
                            <li>
                ...
                @elseif($role == 'Tienda')
                    ...
                    <li>
                        <a href="{{ route('tienda.dashboard') }}"
                            class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('tienda.dashboard') ? 'bg-[#3A3E3B]' : '' }}">
                    ...
                    {{-- Separador visual --}}
                    <li class="px-4 py-2">
                        <div class="border-t border-[#3A3E3B]"></div>
                    </li>

                    {{-- GRUPO: VENTAS --}}
                    <li class="px-4 text-xs font-semibold text-[#F7D600] uppercase tracking-wider">Ventas</li>
                    ...
                    <li>
                        <a href="{{ route('ventas.cotizaciones') }}"
                            class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors ml-4 {{ request()->routeIs('ventas.cotizaciones') ? 'bg-[#484E4A]' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('clientes.index') }}"
                            class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors ml-4 {{ request()->routeIs('clientes.*') ? 'bg-[#484E4A]' : '' }}">
                    ...
                    {{-- GRUPO: INVENTARIO --}}
                    <li class="px-4 text-xs font-semibold text-[#F7D600] uppercase tracking-wider">Inventario</li>
                    
                    <li>
                        <a href="{{ route('tienda.inventario.ver') }}"
                            class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors ml-4 {{ request()->routeIs('tienda.inventario.ver') ? 'bg-[#484E4A]' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('tienda.inventario.solicitudes') }}"
                            class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors ml-4 {{ request()->routeIs('tienda.inventario.solicitudes') ? 'bg-[#484E4A]' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('traslados.pendientes') }}"
                            class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors ml-4 {{ request()->routeIs('traslados.pendientes') ? 'bg-[#484E4A]' : '' }}">
                    ...
                    {{-- GRUPO: CAJA --}}
                    <li class="px-4 text-xs font-semibold text-[#F7D600] uppercase tracking-wider">Caja</li>
                    
                    <li>
                        <a href="{{ route('caja.actual') }}"
                            class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors ml-4 {{ request()->routeIs('caja.actual') || request()->routeIs('caja.abrir') ? 'bg-[#484E4A]' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('caja.index') }}"
                            class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors ml-4 {{ request()->routeIs('caja.index') ? 'bg-[#484E4A]' : '' }}">
                ...
                @elseif($role == 'Vendedor')
                    ...
                    <li>
                        <a href="{{ route('vendedor.dashboard') }}"
                           class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('vendedor.dashboard') ? 'bg-[#3A3E3B]' : '' }}">
                            <i class="fas fa-tachometer-alt mr-3"></i>Dashboard
                        </a>
                    </li>
                ...
                @elseif($role == 'Proveedor')
                    ...
                    <li>
                        <a href="{{ route('proveedor.dashboard') }}"
                            class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('proveedor.dashboard') ? 'bg-[#3A3E3B]' : '' }}">
                            <i class="fas fa-tachometer-alt mr-3"></i>Dashboard
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('proveedor.pedidos') }}"
                            class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-[#3A3E3B] transition-colors {{ request()->routeIs('proveedor.pedidos') ? 'bg-[#3A3E3B]' : '' }}">
        ...
        <div class="p-4 border-t border-[#3A3E3B]">
