...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('luminarias.espacios-proyecto.create') }}" class="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-800">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 text-right space-x-2">
                        <a href="{{ route('luminarias.espacios-proyecto.edit', $espacio) }}" class="text-blue-600 hover:text-blue-900">
