...
<div class="max-w-2xl mx-auto px-4">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-2">Editar: {{ $espacio->nombre }}</h1>
    </div>
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="bg-yellow-500 px-6 py-3">
            <h2 class="text-white font-semibold"><i class="fas fa-edit mr-2"></i>Editar espacio</h2>
        </div>
        <form method="POST" action="{{ route('luminarias.espacios-proyecto.update', $espacio) }}" class="p-6 space-y-4">
            @csrf @method('PUT')
