            ...
            <div class="bg-white rounded-xl shadow-sm border-l-4 border-[#F7D600] p-5">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-[#2B2E2C]/10 rounded-full p-3">
                        <i class="fas fa-clipboard-list text-[#2B2E2C] text-xl"></i>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h3 class="text-lg font-semibold text-gray-800">
                    <i class="fas fa-list mr-2 text-[#2B2E2C]"></i>Lista de Pedidos
                </h3>
                <a href="{{ route('pedidos.create') }}" class="bg-[#2B2E2C] hover:bg-[#2B2E2C] text-white font-semibold py-2 px-4 rounded-lg transition-colors text-sm">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($pedidos as $pedido)
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 text-sm font-mono font-semibold text-[#2B2E2C]">{{ $pedido->codigo }}</td>
                            ...
                            <td class="px-6 py-4 text-sm">
                                <a href="{{ route('pedidos.show', $pedido) }}" class="text-[#2B2E2C] hover:text-[#2B2E2C]" title="Ver">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <a href="{{ route('pedidos.create') }}" class="text-[#2B2E2C] hover:underline mt-2 inline-block text-sm">Crear primer pedido</a>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
